...
export const CheckBox: FC<checkBoxType> = memo(({ index, imgNameSrc }) => {
    ...
    const _removeItems: (inputEl: HTMLInputElement) => void = (inputEl: HTMLInputElement) => {
    ...
    const _fetchContent_removeCheckedAttr_removeItems: (inputEl: HTMLInputElement) => void = (inputEl: HTMLInputElement) => {
    ...
    const _checkedJudge_fetchContent: (inputEl: HTMLInputElement) => void = (inputEl: HTMLInputElement) => {
    ...
    const currentCheckedItemLists: () => string[] = () => {
    ...
    /* チェックボックスのクリックイベント */
    const checkItems: (labelEl: HTMLLabelElement) => void = (labelEl: HTMLLabelElement) => {
